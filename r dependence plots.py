...
test_r_steps = np.linspace(100, 5000, 50).astype(int)

total_L_r_steps = [total_L(i) for i in test_r_steps]

plt.figure(dpi=600)
plt.scatter(test_r_steps, total_L_r_steps, s=1)
plt.xlabel(r'Radial bin number')
